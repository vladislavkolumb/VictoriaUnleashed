...
country = {
	...
	COLONY_TO_STATE_PRESTIGE_GAIN = 15, -- Prestige gain when turning colony to state
	...
	MAX_RESEARCH_POINTS = 95000, -- max RP you can store for uncivs
},
...
military = {
	...
	SIEGE_BRIGADES_MAX = 14, -- the number of brigades above which you get no addition benefit in sieges
	SIEGE_BRIGADES_BONUS = 0.7, -- the bonus to siege speed from each brigade
	RECON_SIEGE_EFFECT = 0.6, -- multiplier to effect of recon on speeding up sieges
...
diplomacy = {
	...
	CRISIS_COOLDOWN_MONTHS = 240,
	CRISIS_BASE_CHANCE = -99,
	CRISIS_TEMPERATURE_INCREASE = -1,
	...
	RANK_1_TENSION_DECAY = -1, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -1,
	RANK_3_TENSION_DECAY = -1,
	RANK_4_TENSION_DECAY = -1,
	RANK_5_TENSION_DECAY = -1,
	RANK_6_TENSION_DECAY = -1,
	RANK_7_TENSION_DECAY = -1,
	RANK_8_TENSION_DECAY = -1,
...
ai =
{
	...
	SPAM_PENALTY = 70, -- makes certain diplomatic action less common 
